...
public class BaseFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        View ivPlayOrPause = root.findViewById(R.id.ivPlayOrPause);
        ...
        App.status.observe(getViewLifecycleOwner(), status -> ivPlayOrPause.setBackgroundResource
                (!status.equals(RadioManager.PlaybackStatus.PLAYING) ? (isLiveBroadcast() ? R.drawable.ic_play : R.drawable.ic_play_circle) : (isLiveBroadcast() ? R.drawable.ic_pause : R.drawable.ic_pause_circle)));
    }
